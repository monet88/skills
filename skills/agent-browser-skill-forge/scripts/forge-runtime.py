...
def build_parser():
    ...
    p_har = sub.add_parser("har-analyze")
    p_har.add_argument("--har", required=True)
    p_har.add_argument("--origin")
    p_har.add_argument("--filter")
    p_har.set_defaults(func=har_analyze)
